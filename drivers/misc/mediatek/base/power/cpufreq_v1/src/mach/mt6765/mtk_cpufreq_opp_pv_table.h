...
static unsigned int c65odTbl[NR_FREQ * NR_MT_CPU_DVFS][ARRAY_COL_SIZE] = {
	/* Freq, Vproc, post_div, clk_div */
	{ 2301, 109, 1, 1 },     /* L */
	{ 2215, 101, 1, 1 },
	{ 2139, 93, 1, 1 },
...
static unsigned int c65xTbl[NR_FREQ * NR_MT_CPU_DVFS][ARRAY_COL_SIZE] = {
	/* Freq, Vproc, post_div, clk_div */
	{ 2200, 109, 1, 1 },   /* L */
	{ 2130, 101, 1, 1 },
	{ 2068,  93, 1, 1 },
...
unsigned int *xrecordTbl[NUM_CPU_LEVEL] = {	/* v1.2 */
	...
	[CPU_LEVEL_9]  = &c65odTbl[0][0],
	[CPU_LEVEL_10] = &c65xTbl[0][0],
};
